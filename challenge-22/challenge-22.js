(function(win,doc){  
  ...
  */
  var pessoa1 = {name : 'Kleber', lastName : 'Freire'};
  var pessoa2 = {name : 'Pedro', lastName : 'Alves'};
  ...
  */
  ...
  function sum(){
    ...
    return Array.prototype.reduce.call(arguments,function(acumulated, atual){
      return parseInt(acumulated) + parseInt(atual);
    })
  }
