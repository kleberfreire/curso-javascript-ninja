...
numberObjects.some(function(item){return item.number === 2})  ? console.log('Existe um objeto { number: 2 } em numberObjects!') : console.log('Não existe um objeto { number: 2 } em numberObjects :(');
