...
var isAux = Brasil.every(function(item){

	return item.length > 7;
})

 isAux ? console.log('Sim, todos os estados tem mais de 7 letras!') : console.log('Nem todos os estados tem mais de 7 letras!') 
...
isAux = Brasil.some(function(item){

	return item === 'Ceará';
})

 isAux ? console.log('Ceará está incluído!') : console.log('Ceará não foi incluído :(') 
